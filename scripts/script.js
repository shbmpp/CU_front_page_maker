...
const SUBJECTS = {
  1: makeSubjects({
    ...
    minor: ["CAGM", "FAGM", "BRGM", "EBGM", "DTGM", "ACGM", "MSGM", "CLGM", "ITGM", "AAGM", "FMGM", "FSGM",
      "MCGM", "MPRM", "MEBS", "MMKC", "MHRM", "MMKT", "MSMT", "MPPM", "ATGM", "ITCM", "MRMS", "MRIM"
    ]
  }, 1),
  2: makeSubjects({
    major: [
...
const validatePaper = debounce(() => {
  ...
  const semPrefixes = {
    ...
    VI: { H: { "DSCC": [13, 14, 15], "MN": [3, 4], "SI": [1] }, G: { "CC": [7, 8], "MN": [5, 6], "SI": [1] } },
  ...
  const semPrefixesCom = {
    ...
    VI: { H: { "DSCC": [13, 14, 15, 12], "MN": [7, 8], "SI": [1] }, G: { /*"DSCC": [13, 14, 15, 12],*/ "MDC": [13, 14, 15, 12], "MN": [6], "SI": [1] } },
    VII: { H: { "DSCC": [16, 17, 18, 19, 20], "RES": [1] }, G: {} },
